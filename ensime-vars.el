...
(defcustom ensime-goto-test-configs
  '(("ensime-server"
     :test-class-names-fn ensime-goto-test--test-class-names-ensime
     :impl-class-names-fn ensime-goto-test--impl-class-names-ensime))
...
The value is an alist of the form:
  ((\"PROJECT-NAME\" . CONFIG-PLIST) ...)

where PROJECT-NAME is a string matched against the current project's
