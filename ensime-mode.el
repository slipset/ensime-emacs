...
(defvar ensime-mode-map
  (let ((map (make-sparse-keymap)))
	...
	'ensime-inspect-type-at-point-other-frame)
      ...
      (define-key prefix-map (kbd "C-b s") 'sbt-start)
      (define-key prefix-map (kbd "C-b S") 'ensime-stacktrace-switch)
      (define-key prefix-map (kbd "C-b c") (lambda () (interactive) (sbt-command "compile")))
      (define-key prefix-map (kbd "C-b n") (lambda () (interactive) (sbt-command "clean")))
      (define-key prefix-map (kbd "C-b o") (lambda () (interactive)
					      (let* ((impl-class
      ...
      (define-key prefix-map (kbd "C-b p") (lambda () (interactive) (sbt-command "package")))
      (define-key prefix-map (kbd "C-b r") (lambda () (interactive) (sbt-command "run")))
      (define-key prefix-map (kbd "C-b T") (lambda () (interactive) (sbt-command "test")))
      (define-key prefix-map (kbd "C-b t") (lambda () (interactive) (sbt-command "testQuick")))
